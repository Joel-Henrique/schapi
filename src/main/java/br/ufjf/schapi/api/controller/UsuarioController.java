...
import br.ufjf.schapi.api.dto.CredenciaisDTO;
import br.ufjf.schapi.api.dto.TokenDTO;
...
public class UsuarioController {
    ...
    public TokenDTO autenticar(@RequestBody CredenciaisDTO credenciais){
        try{
            ...
            String token = jwtService.gerarToken(usuarioAutenticado.getUsername()); // ✅ usar username
